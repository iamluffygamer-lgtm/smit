    ...
    },
    {
        ...
        icon: (
            <svg viewBox="0 0 24 24" width="16" height="16">
                <defs>
                    <radialGradient id="ig_grad" r="1.5" cx="0.2" cy="1" fx="0.2" fy="1">
                ...
                <rect width="24" height="24" rx="5" ry="5" fill="url(#ig_grad)"></rect>
                <path fill="#FFFFFF" d="M12 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm3.98-10.113a1.44 1.44 0 100 2.88 1.44 1.44 0 000-2.88z" />
        ...
        url: 'https://instagram.com/coder_smit'
    },
]
