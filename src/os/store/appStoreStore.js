...
export const APP_CATALOG = [
  ...
  },
  {
    ...
    appId: 'qrGenerator',
    name: 'QR Generator',
    tagline: 'Generate QR codes for any URL or text instantly.',
    description: 'Type any URL or text and get a QR code instantly. Customize size, colors. Download as PNG.',
    category: 'UTILITIES',
    version: '1.0.0',
    size: '0.8 MB',
    author: 'Smit Patil',
  ...
  },
  {
    ...
    appId: 'asciiArt',
    name: 'ASCII Art',
    tagline: 'Convert text to ASCII art. Multiple styles.',
    description: 'Type any text and see it rendered in ASCII art using block characters. Multiple styles and character sets. Copy and use anywhere.',
    category: 'CREATIVE',
    version: '1.0.0',
    size: '0.5 MB',
    author: 'Smit Patil',
  ...
  },
  {
    ...
    appId: 'pixelCanvas',
    name: 'Pixel Canvas',
    tagline: '16×16 pixel art editor. Export as PNG.',
    description: 'Create pixel art on a 16x16 or 32x32 grid. Draw, fill, eyedrop colors. Export as a scaled PNG. Saves automatically.',
    category: 'CREATIVE',
    version: '1.0.0',
    size: '0.7 MB',
    author: 'Smit Patil',
